# CogentNexus-OpenClaw v0.9.3 — Ollama-only provider decision

## Decision

Starting with v0.9.3, CogentNexus-OpenClaw supports **Ollama only** as its managed local inference provider.
