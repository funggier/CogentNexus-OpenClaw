...
"references/architecture.md","references/runtime-toolkit.md","references/recovery-controller.md","references/capability-registry.md","references/artifact-integrity.md","scripts/task_state.py","scripts/cogent.py","scripts/artifact_manifest.py","scripts/capability_registry.py","scripts/recovery_controller.py","assets/task-state-template.json",
"assets/execution-manifest-template.md","assets/lesson-template.md","assets/runtime-state-template.json","assets/ledger-event-template.json","assets/capability-template.json","assets/recovery-plan-template.json"]
def main():
    ...
    for relative in ("assets/task-state-template.json","assets/runtime-state-template.json","assets/ledger-event-template.json","assets/capability-template.json","assets/recovery-plan-template.json"):
        json.loads((ROOT/relative).read_text(encoding="utf-8"))
    for relative in ("scripts/task_state.py","scripts/cogent.py","scripts/artifact_manifest.py","scripts/capability_registry.py","scripts/recovery_controller.py"): ast.parse((ROOT/relative).read_text(encoding="utf-8"),filename=relative)
    ...
    if help_text.returncode or not all(word in help_text.stdout for word in ("state","run","probe","verify","ledger","recover","capability","policy")): raise SystemExit("runtime CLI validation failed")
