...
export function externalizeOversizedSyntheticPayload(input:{
  ...
  const root=resolve(input.workspaceDir,".cogentnexus-openclaw","context","synthetic-input",sessionHash,sha256.slice(0,24));
  ...
  const message=[
    "[CogentNexus-OpenClaw Internal Payload Reference]",
