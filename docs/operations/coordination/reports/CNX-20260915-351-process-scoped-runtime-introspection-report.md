...
Final GitHub HEAD: verified from the remote branch ref after publication; the exact current SHA is recorded by the independent remote read-back performed at closeout.
