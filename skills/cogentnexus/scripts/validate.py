...
EXPECTED = [
    ...
    "scripts/capability_registry.py", "scripts/recovery_controller.py", "scripts/phase3.py", "scripts/validate_templates.py",
    ...
    "assets/recovery-plan-template.json", "assets/phase3-config-template.json",
