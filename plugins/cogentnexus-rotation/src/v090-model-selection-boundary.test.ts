...
describe("v0.9 user model-selection boundary",()=>{
  it("passes sessions.patch model selection through without creating CNX SQLite state",async()=>{
  ...
  it("leaves an existing CogentNexus database byte-identical when the user changes model",async()=>{
