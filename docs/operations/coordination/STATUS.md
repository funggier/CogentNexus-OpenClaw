...
CNX-393 is reviewed and accepted as `GLOBAL_CONFIG_ENTRY_ASSOCIATION_DIAGNOSTICALLY_BLOCKED`. Exact source tracing proved the association chain:
...
- No TicketStore/admission/provider/routing/auth changes.
