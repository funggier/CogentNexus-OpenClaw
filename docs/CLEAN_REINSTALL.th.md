...
ใช้ `scripts/clean-reinstall.ps1` เมื่ออยากเอา CogentNexus-OpenClaw ที่ติดตั้งอยู่ใน workspace ปัจจุบันออกให้สะอาด แล้วติดตั้ง v0.9.7 ใหม่จาก candidate/source package ปัจจุบัน
