...
Default to one inference lane. Treat this as a safe default, not a permanent limit.
    ...
    python skills/cogentnexus/scripts/runtime.py concurrency acquire --kind inference --owner TASK
    python skills/cogentnexus/scripts/runtime.py concurrency release --owner TASK --lease-id ID
