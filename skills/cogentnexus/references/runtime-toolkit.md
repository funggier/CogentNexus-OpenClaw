...
Runtime data defaults to `.cogent/tasks/<task-id>/`:
...
```powershell
python skills/cogentnexus/scripts/cogent.py task init --task-id CNX-001 --goal "Goal"
python skills/cogentnexus/scripts/cogent.py state inspect --task-id CNX-001
python skills/cogentnexus/scripts/cogent.py state commit --task-id CNX-001 --status executing --current-step "step"
python skills/cogentnexus/scripts/cogent.py state rollback --task-id CNX-001 --revision 1
```
...
```powershell
python skills/cogentnexus/scripts/cogent.py ledger append --task-id CNX-001 --type DECISION --summary "Use smaller batches" --data reason=memory-pressure
python skills/cogentnexus/scripts/cogent.py ledger append --task-id CNX-001 --type FAILURE --summary "Generator timed out" --data class=timeout
```
...
```powershell
python skills/cogentnexus/scripts/cogent.py run --task-id CNX-001 --step compile --command "python -m py_compile artifact.py" --timeout 120
```
...
```powershell
python skills/cogentnexus/scripts/cogent.py verify run --task-id CNX-001 --exists artifact.py --hash artifact.py --command "python test_artifact.py"
python skills/cogentnexus/scripts/cogent.py state commit --task-id CNX-001 --status completed --artifact artifact.py
```
...
```powershell
python skills/cogentnexus/scripts/cogent.py ledger tail --task-id CNX-001
python skills/cogentnexus/scripts/cogent.py ledger validate --task-id CNX-001
```
