...
describe("v0.9 manual Compact boundary",()=>{
  ...
  it("does not create SQLite state when a user compacts a session with no existing CNXCLAW context store",()=>{
  ...
  it("never releases an old hold after Reset advanced the CNXCLAW generation",()=>{
