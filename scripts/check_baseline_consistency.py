...
def main() -> int:
    ...
    required_current = (
        ...
        ROOT / f"docs/releases/v{core_version}.md", ROOT / "skills/cogentnexus-openclaw/scripts/host.py",
        ROOT / "skills/cogentnexus-openclaw/scripts/startup.py", ROOT / "plugins/cogentnexus-openclaw/src/delivery-continuity.ts",
    )
