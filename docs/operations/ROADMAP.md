...
## Completed short term — CNX-444 / v0.9.7 qualification
...
14. v0.9.7 was published from exact SHA `43f970895e3b6fe5de6d2f11ffe6bf544fcd2026` and independently checksum-verified.

## Accepted predecessor

CNX-443 / v0.9.6 remains immutable historical release GREEN:
