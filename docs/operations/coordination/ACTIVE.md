...
After report publication, set `ACTIVE.md` and `STATUS.md` to `WAITING_FOR_CHATGPT_REVIEW`, verify local/remote equality and clean worktree, then stop. Do not create/start CNX-402.
