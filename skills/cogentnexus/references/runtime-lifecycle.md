...
CogentNexus lifecycle is driven by persisted operator intent.

## Modes

- MANAGED: CNX owns continuity/recovery and expected managed runtime state.
- PASSTHROUGH: CNX ownership/interception disabled; native OpenClaw remains usable.
