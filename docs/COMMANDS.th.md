# คู่มือคำสั่ง CogentNexus-OpenClaw v0.9.8

คู่มือนี้ใช้กับ CogentNexus-OpenClaw v0.9.8 บน Windows โดยรันจาก OpenClaw workspace:
...
> ใช้ exact GitHub Release และตรวจ `SHA256SUMS.txt` ก่อนติดตั้งเสมอ สถานะ publication จริงให้ยึด GitHub Releases/tags เป็น authority
...
- v0.9.8 จัดการ managed local-provider lifecycle เฉพาะ Ollama และไม่จัดการ LM Studio
